      ...
      <nav class="z-20 bg-[#b5811a] border-b-2 border-gray-30/80">
        ...
        <div v-click-outside="closeMobileNavMenu" v-if="isMobileNavMenuOpen" class="sm:hidden" id="mobile-menu">
          <div class="space-y-1 px-2 pt-2 pb-3">
            ...
            <NuxtLink @click="isMobileNavMenuOpen = false" to="/favourites" class="block rounded-md px-3 py-2 text-base font-medium text-white hover:bg-gray-700 hover:text-white">Favourites</NuxtLink>
          </div>
        </div>
      </nav>  
    </template>
