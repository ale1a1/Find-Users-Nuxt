  ...
  <div class="flex flex-col w-full text-white">  
    ...
    <div v-if="showContent" class="flex-grow flex items-center justify-center">
      <div class="w-auto p-8 flex flex-col items-center justify-center rounded-lg backdrop-blur-[6px]">    
        ...
        <p class="text-xl sm:text-2xl lg:text-5xl font-semibold text-center text-white mb-[5vh] lg:mb-20 mt-[3vh] px-6 lg:px-0">A handy app to find users and get in touch with them</p>  
